...
class NaiveBayesClassifier:
    ...
    def __init__(self): 
        ...
        self.model = pickle.load(open(TEMPLATE_DIRS + "Classifier1/naive_bayes.pkl", "rb"))
        self.vectorizer_from_train_data = pickle.load(open(TEMPLATE_DIRS + "Classifier1/count_vectorizer.pkl", "rb"))
